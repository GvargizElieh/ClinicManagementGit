...
namespace ClinicManagementApi.Utilities
{
    ...
    public class ApiController : ControllerBase
    {
        ...
        protected ApiResult<TData?> CommandResult<TData>(OperationResult<TData> result, string locationUrl = "", HttpStatusCode statusCode = HttpStatusCode.OK)
